...
\newpage
\lstinputlisting[language=Go]{Snippets/GoConcurrency.go}
...
% TODO one section for each of the 4 phases in Choreia (parsing, static analysis, localv views extraction and reconciliation)