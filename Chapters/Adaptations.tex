...
\begin{figure}[ht] \label{fig:Extracted_Local_View}
    \centering
...
\begin{figure}[h!]
    ...
    \end{tikzpicture}
    \caption{Il Choreography Automaton associato al codice sorgente in \ref{lst:DynamicAnalysis}}
\end{figure}