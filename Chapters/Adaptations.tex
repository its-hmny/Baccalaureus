...
Fortunamente in questo fase l'esistenza di una gerarchia \emph{intrinseca} nelle Goroutine ci è di aiuto: sappiamo che inizialmente esiste solo una Goroutine, quella che esegue il \texttt{main}, e sarà questa ad avviare le altre \emph{in cascata}.
